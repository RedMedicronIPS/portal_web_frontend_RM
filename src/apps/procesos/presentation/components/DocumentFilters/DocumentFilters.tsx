  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-2 mb-1">
      <div className={`grid gap-2 grid-cols-1 sm:grid-cols-2 ${permissions.isAdmin ? 'lg:grid-cols-6' : 'lg:grid-cols-5'}`}>
        ...
        <div className={`relative ${permissions.isAdmin ? '' : 'sm:col-span-2 lg:col-span-1'}`}>
          ...
          <input
            ...
            className="pl-9 pr-4 py-2 w-full text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 transition-colors"
          />
        </div>
        <button
          onClick={onClearFilters}
          className="px-3 py-2 text-sm bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors flex items-center gap-1 sm:gap-2 justify-center"
        >
          <FaTimes size={14} />
